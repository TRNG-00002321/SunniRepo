...
Feature: Form Field Validation
  ...
  Scenario Outline: Email field validation
    ...
    Examples: Invalid Emails - Format Issues
      ...
      | user@             | no    | Email must contain top-level domain   |
      | @example.com      | no    | Email must contain username component |
  ...
  Scenario Outline: Password strength validation
    ...
    Examples: Password Strength
      ...
      | abcdefgh | weak        | Password should contain a capital letter A-Z |
      | Abcdefgh | good        | Password should contain a number 1-9         |
      | Abcdefg1 | strong      | Password should contains symbols             |
      | Abcdef1! | very strong | Good Job!                                    |
